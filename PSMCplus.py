...
parser.add_argument('-D','--number_time_windows',help='The number of time windows to use in inference. Suggested value = 32',nargs='?',const=32,type=int,default=30)
parser.add_argument('-spread_1','--D_spread_1',help='Parameter controlling the time interval boundaries. Suggsted value = 0.1',nargs='?',const=0.1,type=float,default=0.1)
parser.add_argument('-spread_2','--D_spread_2',help='Parameter controlling the time interval boundaries. Suggsted value = 50',nargs='?',const=20,type=float,default=20)
